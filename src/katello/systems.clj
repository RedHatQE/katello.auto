...
(swap! ui/uimap merge
       {:new-system                             "new"
        ...
        :system-content-packages                (ui/link "Packages")
        ...
        :system-group-copy                      (ui/link "Copy")
        ...
        :system-group-remove                    (ui/link "Remove")
...
(defn edit
  ...
  (nav/go-to :named-systems-page {:system-name name})
...
(defn edit-system-environment [system-name new-environment]
  ...
  (nav/go-to :named-systems-page {:system-name system-name})
...
(defn subscribe
  ...
  (nav/go-to :system-subscriptions-page {:system-name system-name})
...
(defn create-group
  ...
  (nav/go-to :new-system-groups-page)
  (sel/fill-ajax-form
...
(defn add-to-group
  ...
  (nav/go-to :named-system-group-page {:system-group-name system-group})
...
(defn copy-group
  ...
  (nav/go-to :named-system-group-page {:system-group-name orig-name})
...
(defn edit-group "Change the value of limit field in system group"
  ...
  (nav/go-to :system-group-details-page {:system-group-name sg-name})
...
(defn add-package [name {:keys [package package-group]}]
  (nav/go-to :named-system-page-content {:system-name name})

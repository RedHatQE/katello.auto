...
(def subscriptions-menu
  [:subscriptions (browser-fn (browser/move-to ::subscriptions-link))
...
(def systems-menu
  [::systems-menu (browser-fn (browser/move-to ::systems-link))
...
(def right-hand-menus
  (list [:katello.notices/page (browser-fn (browser/click ::notifications-link))]
        ...
        [::administer-menu (browser-fn (browser/move-to ::administer-link))
...
(nav/defpages :katello.deployment/katello katello.navigation
  (concat [::nav/top-level
           ...
           [::org-context (fn [ent] (nav/switch-org (kt/org ent)))
            ...
            [::content-menu (browser-fn (browser/move-to ::content-link))
             subscriptions-menu

             [::repositories-menu (browser-fn (browser/move-to ::repositories-link))
              [:katello.providers/products-page (browser-fn (browser/click ::products-link))]
             ...
             [::sync-management-menu (browser-fn (browser/move-to ::sync-management-link))
             ...
             [::changeset-management-menu (browser-fn (browser/move-to ::changeset-management-link))
